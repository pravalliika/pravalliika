...
<img src="https://readme-typing-svg.demolab.com?font=Inter&weight=500&size=16&duration=2800&pause=900&color=6366F1&center=true&vCenter=true&width=560&lines=kubectl+apply+-f+everything.yml+%E2%9C%85;Ship+fast.+Stay+secure.+Never+break+prod.;AWS+%7C+EKS+%7C+Terraform+%7C+ArgoCD+%7C+Bedrock;Building+AI-powered+DevOps+pipelines+%F0%9F%A4%96;Open+to+DevOps+%7C+DevSecOps+%7C+SRE+roles+%F0%9F%9A%80"/>
</div>
---
...
```yaml
name     : Pravallika Medisetti
role     : DevOps · DevSecOps · AIOps Engineer
location : Hyderabad, India 🇮🇳
cloud    : AWS (Primary) · Azure · GCP
 
specialization:
  - End-to-end CI/CD & GitOps with ArgoCD
  - DevSecOps — Trivy · SonarQube · OWASP · ESO
  - AI-powered Ops — AWS Bedrock · SageMaker
  - Kubernetes on EKS — Helm · cert-manager · RBAC
  - Infrastructure as Code — Terraform · Ansible
 
currently:
  - 🤖 Building AIOps projects with Bedrock & SageMaker
  - 📜 Targeting AWS DevOps Engineer Professional cert
  - ✍️  Writing real DevOps scenarios on Medium
  - 🚀 Open to DevOps · DevSecOps · SRE · Platform Eng roles
 
quote: "I don't just run pipelines —
        I build infrastructure teams trust in production."
```
...
<img src="https://img.shields.io/badge/Bedrock_Nova_Lite-FF9900?style=flat-square&logo=amazonaws&logoColor=white"/>
<img src="https://img.shields.io/badge/EKS-FF9900?style=flat-square&logo=amazonaws&logoColor=white"/>
<img src="https://img.shields.io/badge/ArgoCD-EF7B4D?style=flat-square&logo=argo&logoColor=white"/>
---
...
<a href="https://github.com/pravalliika/k8s-ecommerce-microservices-cicd"><img src="https://img.shields.io/badge/GitHub-k8s--ecommerce--microservices--cicd-181717?style=flat-square&logo=github"/></a>
<img src="https://img.shields.io/badge/EKS-FF9900?style=flat-square&logo=amazonaws&logoColor=white"/>
...
<a href="https://github.com/pravalliika/aws-log-analytics-cloudwatch-athena"><img src="https://img.shields.io/badge/GitHub-aws--log--analytics--cloudwatch--athena-181717?style=flat-square&logo=github"/></a>
...
<img src="https://img.shields.io/badge/EFK_Stack-005571?style=flat-square&logo=elastic&logoColor=white"/>
<img src="https://img.shields.io/badge/GitHub_Actions-2088FF?style=flat-square&logo=githubactions&logoColor=white"/>
...
| Area | What I Do |
|:-----|:----------|
| ☁️ **AWS Cloud** | EKS · ECR · RDS · S3 · IAM · CloudWatch · Athena · Bedrock · SageMaker |
| ⚙️ **CI/CD** | Jenkins & GitHub Actions — build · test · scan · push · deploy |
| 🔄 **GitOps** | ArgoCD — auto-sync to EKS, self-healing deployments |
| 🏗️ **IaC** | Terraform — EKS clusters · VPC · RDS · IAM · security groups |
| 🔐 **DevSecOps** | SonarQube · Trivy · OWASP ZAP · External Secrets Operator |
| 🤖 **AIOps** | Bedrock Nova Lite · Bedrock Claude · SageMaker ML endpoints |
| 📊 **Observability** | Prometheus · Grafana · EFK Stack · CloudWatch · Athena SQL |
...
| 🌟 Contribute to open-source cloud-native projects | 📋 Planned |
| 🏅 Earn CKA — Certified Kubernetes Administrator | 📋 Planned |
...
<img src="https://komarev.com/ghpvc/?username=pravalliika&style=flat-square&color=6366f1&label=Profile+Views"/>
<br/><br/>
